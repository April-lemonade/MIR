...
<form name=form action="form.asp" method=post target=_blank>
	<h3 >姓名: <input type="text" size=10 name="person"></h3>
	<h3 >密码: <input type="password" size=10 name="password"></h3>
		<div>
			<input type=submit value="登录">
		</div>
</form>
		<input type=button onclick="location.href = 'rollin.asp'" value="注册">
</center>
<hr>
