...
If Not checkMirPassword(person, password) Then %>
	<p align=center>亲爱的 <font color=green><%=person%></font>，您的认证资料错误，请回<a href="default.asp">前页</a>修改。
	<% Response.End
End If
%>

<center>[<a href=listEachPerson.asp?person=<%=person%>><%=person%>的所有登录资料</a>]</center>
